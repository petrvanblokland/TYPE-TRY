...
for n, (image, title, subTitle) in enumerate((
    (   'images/booklet/Typetr_Typographics_2022_0930.jpg',
        '[html]<span style="font-family:Presti_Display-Normal;font-size:48;color:red;">Try Presti</span>', 
        ''),
    (   'images/booklet/Typetr_Typographics_2022_0928.jpg',
        '[html]<span style="font-family:Responder_P-Black;font-size:48">Try Responder</span>', 
        ''),
...
p.articleHead_1 = 'TYPE-TRY upcoming releases'
