...
### Download the Opcode-Try TTF files.

Note that the TYPE-TRY fonts are for review only. Therefor a limited glyphset is implemented as sneak preview. Refer to the Type Network store for a full license or email directly.

* [Opcode-Try](downloads/Opcode_Try_BaseMasters001.zip)
